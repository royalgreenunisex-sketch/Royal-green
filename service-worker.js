const CACHE_NAME = 'rg-billing-v10'; // bump this number whenever the app is updated
const APP_SHELL = ['./', './index.html', './staff-portal.html', './manifest.json', './icon-192.png', './icon-512.png'];
